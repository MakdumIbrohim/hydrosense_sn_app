              ...
              NeumorphicContainer(
                ...
                child: InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Center(
                      child: _isLoading 
                        ? const SizedBox(width: 24, height: 24, child: CircularProgressIndicator(color: Color(0xFFA78BFA), strokeWidth: 2))
                        : const Text('SIMPAN KALIBRASI', style: TextStyle(fontWeight: FontWeight.bold, letterSpacing: 1, color: Color(0xFFA78BFA))),
                    ),
                  ),
                ),
              ),
