                  ...
                  children: [
                    ...
                    GridView.count(
                      ...
                      children: [
                        ...
                        SensorCardWidget(title: 'TDS', value: data.tds.toStringAsFixed(2), unit: 'ppm', min: 0, max: 2000, color: const Color(0xFFA78BFA)), // Purple
                        SensorCardWidget(
                          title: 'Suhu Air', 
                          value: data.waterTemperature.toStringAsFixed(2), 
                          unit: '°C', 
                          min: 0, 
                          max: 50, 
