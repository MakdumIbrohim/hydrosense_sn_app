              ...
              child: Column(
                ...
                children: [
                  ...
                  GridView.count(
                    ...
                    children: [
                      SensorCardWidget(title: 'pH Air', value: data.ph.toStringAsFixed(1), unit: 'pH', icon: Icons.water_drop, statusColor: AppColors.success, iconColor: Colors.blue),
                      ...
                      SensorCardWidget(title: 'Volume', value: data.waterVolume.toStringAsFixed(1), unit: 'L', icon: Icons.waves, statusColor: AppColors.success, iconColor: Colors.cyan),
                    ],
                  ),
                  const SizedBox(height: 24),
